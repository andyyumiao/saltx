...
class SaltMaid(parsers.SyndicOptionParser, DaemonsMixin):
    ...
    def start(self):
        ...
        self.bootConfig = {'_sub_node': self.config['id'], '_channel_redis_sentinel': self.config['channel_redis_sentinel'], '_channel_redis_password': self.config['channel_redis_password'], '_master_pub_topic': self.config['super_master']}
